...
## Descriptives
In @tbl-1 I show basic descriptives of the study population. We see that most children are born between 1980 and 2000, and that the total number is 40,934. We also see that all regions have quite large samples except for Southern Europe, which onluy have around 4,000 children included from just two countries. This means that we need to take the results from Southern Europe with a grain of salt in the final analysis. 
...
I performed a set of 100 botstraps an
