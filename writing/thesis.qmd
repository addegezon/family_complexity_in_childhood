...
I will discuss the results in three parts. Firstly, I will describe the results of the cluster diagnostic tests to determine the optimal number of groups to select from the cluster analysis. Secondly, I will describe the groups selected and how they are related to familydemographic processes. Finally, I will show how common these childhood family structure groups are across European countries regions. I will highlight both between and within regional difference as well as show the relation with maternal educational level. 
...
First off, there seems to be a North-South divid in the probability of children experiencing an _Intact original family_. In Northern and Western Europe, the average is around 77-80% for Norway, Sweden, Belgium and France. Austria has a lower proportion of around 72% and the Netherlands has a much higher proportion of children in this cluster (88%). If we contrast this to Southern Europe, we see that the averages are 91% for Italy and 85% for Spain. The same divide can be seen among the Eastern countries where all Central-Eastern countries except for Poland and Hungary have a proportion lower than 80% in this group while the South-Eastern proportion is closer to 90%. In general, this is the same pattern found in Table A-31 in @andersson_life-table_2017, where the proportion belonging to the group _Intact original family_  is similar to the cumulative percent ever out of union at age 15. Although the regional patterns are similar the levels differ, which I will return to in the discussion. 


From this table it is hard to discover general regional patterns for the other cluster so in order to discover them, I calculate the relative risk of belonging the each cluster in each region, as compared to the European mean risk. This is shown in @fig-map-cluster. A value close to one indicates that the risk of belonging to a particular cluster is the same in that region as the average risk in Europe. A value higher than one (green colors in the figure) indicates that the cluster is more common in that region than the European average. So a value of 2 shows that the cluster is twice is common in a given region as compared to the European average. At the other end, values lower than one (purple colors) indicate that the cluster is less common than on average in Europe.
...
Looking at these six maps, we see regional patterns emerge that were not immediately visible in @tbl-proportion-family-type. For clarity of visualisations, the group _Intact original family_ is not shown here. To start off with the _Original family to stepfamily_, we see that the Nordic region stands out where this group is around twice as common as the European mean. On the other end of the spectrum we have the Southern countries, Italy and Spain, where belonging to this group is around half as common as in Europe on average. Belonging to this group is also more common in Western European countries than in Europe on average, but looking at  @tbl-proportion-family-type we see that Netherlands is an exception within the region where belonging to the group _Original family to stepfamily_ is limited to 2.47% of children (which is less than the European average). In Eastern Europe it is less common to belong to this group on average, and even more so for the South-Eastern than the Central-Eastern countries. Among the Central-Eastern countries, Estonia is an outlier where 6.26% of children experience this family structure (compared to 1.5-30% among the other countries in the region) which is the highest percentage in Europe after Sweden (7.53%).

Looking at the other clusters, we also see a consistent North/South divide in the relative risk of children belonging to each cluster. South-Eastern Europe has a lower relative risk for all other clusters. Southern Europe also has a lower relative risk for the groups _Original family to stepfamily_, _Separation_ and _Single mother_, but a s slightly above average risk of children belonging to the groups _Early_- and _Late stepfamily_. This pattern reflects that out of those children born to a single mother, Southern European children tend to experience a maternal re-partnering at some point to a higher degree than children from Western, Northern and Central-Eastern Europe.
