...
Understanding the family structures and transitions of children are not only important from a purely descriptive point of view, but also because both family structure and transitions have the potential to influence child wellbeing and future outcomes [@fomby_family_2007]. 

<!-- 
Since it has been proposed that family transitions have a negative effect on the well-being of children [@fomby_family_2007] and because there is evidence of this effect [@hadfield_changes_2018], it is important to understand to what extent children experience family transitions and what the patterns are. Demographic studies that have been conducted on children's experience of family disruption and parental re-partnering [such as @andersson_childrens_2002;@kennedy_childrens_2010; @thomson_family_2014] have primarily looked at the degree to which children experience particular events. Albeit important, this does not fully capture the accumulated experience of family complexity over childhood. 
 -->
...
As outlined in the theory section, we can expect these patterns to shift once we take the mother's socioeconomic status into account and therefore I also present the cluster distributions by maternal educational level. In @fig-map-edu this is visualized as a matrix of maps with the cluster on the x-axis and maternal educational level on the y-axis. The color of the countries is once again representing a kind of relative risk, but this time not between countries but rather between educational levels within countries. In this case, a relative risk of 1 indicates that the particular cluster is as common within that maternal educational level as it is in countries population as a whole, disregarding maternal education. A relative risk of 2 indicates that the particular cluster is twice as common among children to mothers of that particular educational level, in relation to the population as a whole. This illustrates if children of particular clusters are over- or underrepresented among mothers of low, medium or high educaiton for each individual country. The cluster  _Intact original family_ has its own scale for the plot colors in order for the differences between educational levels to be visible.
...
Moving to the _Original family to stepfamily_ cluster, we see that this cluster is overrepresented among children whose mothers have primary and secondary education among many of the Northern, Western and Central countries (Norway, Sweden, Estonia, Lithuania, Netherlands, Czech Republic, Austria and to some degree France). But for the Southern axis this cluster is underpresented among children to mothers with only primary education and is instead overrepresented among children who's mothers have secondary or tertiary education. For instance, the relative risk of children of this cluster to have a mother with secondary education in Italy is `r p_map_edu_complex[[2]][COUNTRY == "Italy" & cluster == "Original family to stepfamily" & EDU_3 == "Secondary", round(relative_risk,2)]`. The Polish case shows a similar pattern as in the case of the _Intact original family_-cluster. Also here, the cluster is overpresented among children to mothers with primary and tertiary education, but underepresented among children to mothers with medium education.
