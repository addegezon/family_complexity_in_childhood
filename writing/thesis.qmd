...
In @fig-cluster-proportion we see the proportion of children that are in each cluster, on a country by country basis. 

```{r}
#| echo: false
#| label: fig-cluster-proportion
#| fig-cap: "Proportion of children belonging to each cluster by country, grouped by region"
#| fig-height: 8
