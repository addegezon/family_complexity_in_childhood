---
title: "Childhood Family Structure and Sibling Composition in Europe: A Sequence Analysis Approach to Family Complexity"
...
Once the family typology is in place, I will show the proportion of the different family types for each region in the study, thus providing a descriptive of how children's family trajectories vary across Europe. This will mirror the work of van Winkle [-@van_winkle_family_2018, Table A5], but from the perspective of children. I will also show how the different typologies are associated with having full- and maternal half-siblings, on a regional basis. Apart from mapping the relationship between family trajectories and sibling composition, it will also be one of the first cross-European analyses on half-sibling prevalence. This will further contribute to the understanding of the relationship between parental union history and sibling composition as well as showing the differences and similarities between European regions.
...
In the next step, I provide a description of the proportions of children which belong to each cluster, on a country level. Provided both as visualizations and tabulations. This allows us to detect similarities and differences between European countries as it relates to children's family experiences. In the final step I also relate parental union histories to sibling composition by cross-tabulating cluster membership with indicators of having full- and half-siblings for each country. 
...
## Descriptives
In @tbl-1 I show basic descriptives of the study population. We see that most children are born between 1980 and 2000, and that the total number is 40,934. We also see that all regions have quite large samples except for Southern Europe, which only have around 4,000 children included from just two countries. This means that we need to take the results from Southern Europe with a grain of salt in the final analysis. 
...
I performed a set of 50 bootstraps an
