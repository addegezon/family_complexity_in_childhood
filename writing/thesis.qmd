---
title: "Childhood Family Structure and Sibling Composition in 17 European Countries: A Sequence Analysis Approach to Family Complexity"
...
The objective of this thesis is to provide a descriptive analysis of children's family structure trajectories in Europe. In particular I will answer the questions (1) What are the most common family trajectories among European children, and how do they vary across countries? (2) How are these trajectories related to the risk of having full- and half-siblings for children? (3) How does the probability of experiencing a particular family trajectory differ by the mother's socioeconomic status? This will be accomplished by generating a set of family history sequences for European children, based on the Harmonized History data set. Analysis will be performed by sequence analysis, through which I will generate clusters of the most common family trajectories of European children. I will then perform a descriptive analysis of the proportion of children who experience these trajectories on a country by country basis. Further, I will describe how the most common trajectories are associated with the probability of having full- and half-siblings as well as the risk of experiencing a particular trajectory based on the mother's socioeconomic status. Taken together, the main contributions of this thesis will be a deepened understanding of the drivers of family complexity, and how they differ between European countries as well as the first cross-European analysis on the prevelence of half-siblings. 
...
<!-- 
  Consequences of STATES: single mother, stepfamily. 
  Consequences of TRANSITIONS: divorce, marriage

  Sequence analysis captures both states and the timing of transitions
-->
...
<!-- ## Taking the child perspective 

There are many reasons why one would chose to adopt a child perspective when investigating family complexity.

... -->

<!-- @kalmijn_multi-actor_2018 -->

## Tracing family complexity

<!-- complexity in "family complexity" sense, but also in Elzinga (2010) sense -->

<!-- 
The variety of childhood family structures have been extensively documented in the US context, but less so in Europe. I will first summarize these rich findings from the US, then turn toward the European context and finally discuss some of the literature on the consequences of childhood family complexity. 
...
__FURTHER DESCRIPTION OF SURVEY DESIGN, RESPONSE RATE ETC__
...
The "Multiple single spells" cluster is the smallest but also most complex. Here we see that most, but not all, children are born to a single mother, eventually experience stepfamily formation and then all do at some point live with just a single mother again. The above pattern is also found for some individuals in the "Early stepfamily" cluster, but here divorce after stepfamily formation is much more uncommon, and all children live in a stepfamily before the age of five.

The sixth category, "Single mother to stepfamily", seems to contain some heterogeneity within the cluster where we see two common forms of family trajectories. The dominant one, which I've named the cluster after, consists of children being born to a single mother and who then enter a stepfamily between the age of four and 10. There is also a small group who are born into a union but experience a divorce shortly afterwards, before entering a stepfamily around the ages 4 to 8. Finally, the cluster "Single mother" consists mostly of children who spend their entire childhood with a single mother, but there are som who also live in a stepfamily for a brief period of time.

In @tbl-proportion-family-type we see the proportion of children that are in each cluster, on a country by country basis. 
...
```{r}
#| echo: false
#| label: fig-cluster-proportion
#| fig-cap: "Proportion of children belonging to each cluster by country, with 95% confidence intervals. The cluster 'Intact original family' have been removed for clarity of visualization."
#| fig-height: 8

tar_read(p_cluster_proportions) +
  theme(
...
```{r}
#| echo: false
#| label: fig-sib-proportion
#| fig-cap: "Proportion with full- and half-sibling by country and family cluster, with 95% confidence intervals. The shaded dots represents country and cluster combinations where there are fewer than 100 observations."
#| fig-width: 20
#| fig-asp: 0.6
